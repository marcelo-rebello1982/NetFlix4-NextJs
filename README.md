...
<p><font size="3">
  This is a clone of Netflix website built using <strong><em>NEXT.JS & Styled Components</em></strong> as a Front-end & <strong><em>Firebase</em></strong> as Back-end. It's not a replica, and it doesn't have all the features of Netflix website. it's a similar version of Netflix with my own design touch, showing my abilities in NEXT.JS & Styled Components to build something advanced like Netflix. It contains the home page, sign-in page, sign-up page, browse page, and movie player.
  <br><br> 
  <strong><em>Take a look at the live version here:</em></strong> https://next-js-netflix-clone.vercel.app/ :octocat: :heart_eyes:
</p>
...
**_Take a look on the live version here:_** https://next-js-netflix-clone.vercel.app/ :octocat: :heart_eyes:
...
```js
const config = {
  apiKey: 'AIzaSyD3ym95KINCA8jq96HrUcxtL5sVnkrkbzY',
  authDomain: 'netflix-nextjsmp.firebaseapp.com',
  databaseURL: '',
  projectId: 'netflix-nextjsmp',
  storageBucket: 'netflix-nextjsmp.appspot.com',
  messagingSenderId: '120131639641',
  appId: '1:120131639641:web:fb6e356407885a49ced448',
};
```
...
3) Wait 2 minutes and check your firebase database , if you found the data there then re-comment the above 2 lines.
   If you did not re-commet the above 2 lines after the seeding process, you will get dupliacted data in your
   firebase database.
